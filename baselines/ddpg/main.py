...
from baselines.ddpg.models import Actor, WeightSharingActor, Critic
...
def run(env_id, seed, noise_type, layer_norm, evaluation, weight_sharing, **kwargs):
    # Configure things.
...
def parse_args():
    ...
    parser.add_argument('--nb-eval-runs', type=int, default=5)
